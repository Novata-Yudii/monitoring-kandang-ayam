...
@section('content')
  <div class="container">
    <h2 style="color: white; margin-top: 20px; margin-bottom: 25px;">Control Lampu</h2>          
  ...
  <script>
    ...
    function animatedToogle(){
      ...
      if(toogle.classList.contains('active')){
        ...
        $.post("http://127.0.0.1:8000/api/lampu/manual",{
        ...
        let pub = {"value" : 0, "device_kode" : deviceKode.value, "name" : "lampu"}
        ...
        // Post to mikrokontroler over mqtt
        let pub = {"value" : 1, "device_kode" : deviceKode.value, "name" : "lampu"}
        pub = JSON.stringify(pub);
        client.publish('/lampu', pub, function(err){
          if (err) {
              console.log(err)
